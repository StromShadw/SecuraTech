                    ...
                    <Col md={6} lg={4} >
                        <div className="footer-widget footer-widget--about">
                            <Link href="/" className="footer-widget__logo">
                                <Image src={logo} width={200} style={{ height: "auto" }} alt="Tolak NextJS Template" />
                            </Link>
                            <ul className="footer-widget__info">
                                ...
                                <li><span className={widgetInfo.telIcon1}></ span><Link href={`${widgetInfo.subHref1}:${widgetInfo.tel1}`}>{widgetInfo.tel1}</Link></li>
                                <li><span className={widgetInfo.telIcon2}></ span><Link href={`${widgetInfo.subHref2}:${widgetInfo.tel2}`}>{widgetInfo.tel2}</Link></li>
